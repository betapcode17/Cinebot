...
export const getFavoriteTVShowApi = async (accountId, sessionId, page = 1) => {
...
export const getFavoriteMovieApi = async (accountId, sessionId, page = 1) => {
  const { data } = await api.get(`/account/${accountId}/favorite/movie`, {
    params: { session_id: sessionId, page },
  });
  return data;
};
