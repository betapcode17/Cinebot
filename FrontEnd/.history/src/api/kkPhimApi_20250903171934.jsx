...
export const getSingleMovies = async ({
  ...
  try {
    const params = {
      ...
      sort_type: sortType,
      sort_lang: sortLang,
      filterCategory: category ? [category] : [], // Chuyển thành mảng như API mẫu
      filterCountry: country ? [country] : [], // Chuyển thành mảng như API mẫu
      filterYear: year ? [year] : [], // Chuyển thành mảng như API mẫu
    };
