...
export const getSingleMovies = async ({
  ...
  try {
    const params = {
      ...
      sort_type: sortType,
      sort_lang: sortLang,
      filterCategory: category ? [category] : [], // Chuyển thành mảng
      filterCountry: country ? [country] : [], // Chuyển thành mảng
      filterYear: year ? [year] : [], // Chuyển thành mảng
    };
    ...
    const res = await api.get(`/v1/api/danh-sach/phim-le`, { params });
