...
const CinemaMovies = () => {
  ...
  const fetchMovies = async () => {
    ...
    try {
      ...
      // Cập nhật totalPages nếu API trả pagination
      const apiTotalPages = res.data.data?.pagination?.totalPages;
      if (apiTotalPages) {
        setTotalPages(apiTotalPages);
      } else {
        // Nếu API không trả pagination, tính tạm theo số item / 20
