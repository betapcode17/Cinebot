          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div>
              ...
              <div className="flex flex-row gap-x-4">
                <Link to={`/movie/${movie.slug}/watch`}>
          ...
          {(movie.actor?.length > 0 || movie.director?.length > 0) && (
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {movie.actor?.slice(0, 8).map((actor, index) => (
                  <div
                    key={`actor-${index}`}
                    className="bg-gray-800 p-2 rounded-lg text-center"
                  >
                    <img
                      src="https://via.placeholder.com/150" // No profile_path in API
                      alt={actor}
                ...
                {movie.director?.slice(0, 4).map((director, index) => (
                  <div
                    key={`director-${index}`}
                    className="bg-gray-800 p-2 rounded-lg text-center"
                  >
                    <img
                      ...
                      className="w-full h-48 object-cover rounded"
                    />
                    <p className="mt-2 font-semibold">{director}</p>
